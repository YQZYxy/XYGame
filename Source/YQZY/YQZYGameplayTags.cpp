...
namespace YQZYGameplayTags
{
	...
	// When extending YQZY, you can create your own movement modes but you need to update GetCustomMovementModeTagMap()
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Movement_Mode_Custom, "Movement.Mode.Custom", "This is invalid and should be replaced with custom tags.  See YQZYGameplayTags::CustomMovementModeTagMap.");
