...
#include "YQZYCheatManager.generated.h"
...
DECLARE_LOG_CATEGORY_EXTERN(LogYQZYCheat, Log, All);
...
class UYQZYCheatManager : public UCheatManager
{
	GENERATED_BODY()
...
protected:
	...
	void ApplySetByCallerDamage(UYQZYAbilitySystemComponent* YQZYASC, float DamageAmount);
	void ApplySetByCallerHeal(UYQZYAbilitySystemComponent* YQZYASC, float HealAmount);

	UYQZYAbilitySystemComponent* GetPlayerAbilitySystemComponent() const;
};
