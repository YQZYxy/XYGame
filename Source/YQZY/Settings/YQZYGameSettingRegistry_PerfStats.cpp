...
#include "CustomSettings/YQZYSettingValueDiscrete_PerfStat.h"
...
void UYQZYGameSettingRegistry::AddPerformanceStatPage(UGameSettingCollection* PerfStatsOuterCategory, UYQZYLocalPlayer* InLocalPlayer)
{
	//----------------------------------------------------------------------------------
	{
		static_assert((int32)EYQZYDisplayablePerformanceStat::Count == 15, "Consider updating this function to deal with new performance stats");
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			//----------------------------------------------------------------------------------
			{
				UYQZYSettingValueDiscrete_PerfStat* Setting = NewObject<UYQZYSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EYQZYDisplayablePerformanceStat::ClientFPS);
			...
			{
				UYQZYSettingValueDiscrete_PerfStat* Setting = NewObject<UYQZYSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EYQZYDisplayablePerformanceStat::ServerFPS);
			...
			{
				UYQZYSettingValueDiscrete_PerfStat* Setting = NewObject<UYQZYSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EYQZYDisplayablePerformanceStat::FrameTime);
			...
			{
				UYQZYSettingValueDiscrete_PerfStat* Setting = NewObject<UYQZYSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EYQZYDisplayablePerformanceStat::IdleTime);
			...
			{
				UYQZYSettingValueDiscrete_PerfStat* Setting = NewObject<UYQZYSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EYQZYDisplayablePerformanceStat::FrameTime_GameThread);
			...
			{
				UYQZYSettingValueDiscrete_PerfStat* Setting = NewObject<UYQZYSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EYQZYDisplayablePerformanceStat::FrameTime_RenderThread);
			...
			{
				UYQZYSettingValueDiscrete_PerfStat* Setting = NewObject<UYQZYSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EYQZYDisplayablePerformanceStat::FrameTime_RHIThread);
			...
			{
				UYQZYSettingValueDiscrete_PerfStat* Setting = NewObject<UYQZYSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EYQZYDisplayablePerformanceStat::FrameTime_GPU);
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			{
				UYQZYSettingValueDiscrete_PerfStat* Setting = NewObject<UYQZYSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EYQZYDisplayablePerformanceStat::Ping);
			...
			{
				UYQZYSettingValueDiscrete_PerfStat* Setting = NewObject<UYQZYSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EYQZYDisplayablePerformanceStat::PacketLoss_Incoming);
			...
			{
				UYQZYSettingValueDiscrete_PerfStat* Setting = NewObject<UYQZYSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EYQZYDisplayablePerformanceStat::PacketLoss_Outgoing);
			...
			{
				UYQZYSettingValueDiscrete_PerfStat* Setting = NewObject<UYQZYSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EYQZYDisplayablePerformanceStat::PacketRate_Incoming);
			...
			{
				UYQZYSettingValueDiscrete_PerfStat* Setting = NewObject<UYQZYSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EYQZYDisplayablePerformanceStat::PacketRate_Outgoing);
			...
			{
				UYQZYSettingValueDiscrete_PerfStat* Setting = NewObject<UYQZYSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EYQZYDisplayablePerformanceStat::PacketSize_Incoming);
			...
			{
				UYQZYSettingValueDiscrete_PerfStat* Setting = NewObject<UYQZYSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EYQZYDisplayablePerformanceStat::PacketSize_Outgoing);
