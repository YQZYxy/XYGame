...
#include "YQZYSettingValueDiscreteDynamic_AudioOutputDevice.generated.h"
...
UCLASS()
class UYQZYSettingValueDiscreteDynamic_AudioOutputDevice : public UGameSettingValueDiscreteDynamic
{
	GENERATED_BODY()
	
public:

	virtual ~UYQZYSettingValueDiscreteDynamic_AudioOutputDevice() = default;
