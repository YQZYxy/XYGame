...
#include "YQZYGameplayAbility_RangedWeapon.generated.h"

enum ECollisionChannel : int;

class APawn;
class UYQZYRangedWeaponInstance;
class UObject;
...
UENUM(BlueprintType)
enum class EYQZYAbilityTargetingSource : uint8
{
...
/**
 * UYQZYGameplayAbility_RangedWeapon
 *
 * An ability granted by and associated with a ranged weapon instance
 */
UCLASS()
class UYQZYGameplayAbility_RangedWeapon : public UYQZYGameplayAbility_FromEquipment
{
	GENERATED_BODY()

public:

	UYQZYGameplayAbility_RangedWeapon(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	UFUNCTION(BlueprintCallable, Category="YQZY|Ability")
	UYQZYRangedWeaponInstance* GetWeaponInstance() const;
...
protected:
	struct FRangedWeaponFiringInput
	{
		...
		UYQZYRangedWeaponInstance* WeaponData = nullptr;
...
protected:
	...
	FTransform GetTargetingTransform(APawn* SourcePawn, EYQZYAbilityTargetingSource Source) const;
