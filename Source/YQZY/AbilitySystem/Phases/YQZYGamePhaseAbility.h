...
#include "YQZYGamePhaseAbility.generated.h"

/**
 * UYQZYGamePhaseAbility
 *
 * The base gameplay ability for any ability that is used to change the active game phase.
 */
UCLASS(Abstract, HideCategories = Input)
class UYQZYGamePhaseAbility : public UYQZYGameplayAbility
{
	GENERATED_BODY()

public:

	UYQZYGamePhaseAbility(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "YQZY|Game Phase")
