...
#include "YQZYGameplayCueManager.generated.h"
...
/**
 * UYQZYGameplayCueManager
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class UYQZYGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	UYQZYGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UYQZYGameplayCueManager* Get();
