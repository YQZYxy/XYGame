...
#include "YQZYAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FYQZYAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class UYQZYAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FYQZYAbilityTagRelationship> AbilityTagRelationships;
