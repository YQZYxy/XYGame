...
#include UE_INLINE_GENERATED_CPP_BY_NAME(YQZYExperienceDefinition)

#define LOCTEXT_NAMESPACE "YQZYSystem"

UYQZYExperienceDefinition::UYQZYExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UYQZYExperienceDefinition::IsDataValid(FDataValidationContext& Context) const
{
...
void UYQZYExperienceDefinition::UpdateAssetBundleData()
{
