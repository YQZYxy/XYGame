...
#include "YQZYGameMode.generated.h"
 ...
 */
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnYQZYGameModePlayerInitialized, AGameModeBase* /*GameMode*/, AController* /*NewPlayer*/);
...
class AYQZYGameMode : public AModularGameModeBase
{
	GENERATED_BODY()

public:

	AYQZYGameMode(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	UFUNCTION(BlueprintCallable, Category = "YQZY|Pawn")
	const UYQZYPawnData* GetPawnDataForController(const AController* InController) const;
	...
	FOnYQZYGameModePlayerInitialized OnGameModePlayerInitialized;
