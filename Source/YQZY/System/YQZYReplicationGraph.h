...
#include "YQZYReplicationGraph.generated.h"
...
class UYQZYReplicationGraph : public UReplicationGraph
{
	GENERATED_BODY()

public:
	UYQZYReplicationGraph();
...
private:
	...
	/** Classes that had their replication settings explictly set by code in UYQZYReplicationGraph::InitGlobalActorClassSettings */
	TArray<UClass*> ExplicitlySetClasses;
};

UCLASS()
class UYQZYReplicationGraphNode_AlwaysRelevant_ForConnection : public UReplicationGraphNode_AlwaysRelevant_ForConnection
{
	GENERATED_BODY()
...
*/
UCLASS()
class UYQZYReplicationGraphNode_PlayerStateFrequencyLimiter : public UReplicationGraphNode
{
	GENERATED_BODY()
