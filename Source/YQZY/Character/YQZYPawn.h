 ...
 */
UCLASS()
class YQZY_API AYQZYPawn : public AModularPawn, public IYQZYTeamAgentInterface
{
	GENERATED_BODY()

public:

	AYQZYPawn(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
