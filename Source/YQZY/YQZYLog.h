...
#define YQZYDebug(format, ...) UE_LOG(YQZYLog, Log, TEXT("[%s<%d>]  " format), TEXT(*FString(__FUNCTION__)),  __LINE__, ##__VA_ARGS__)
#define YQZYWarning(format, ...) UE_LOG(YQZYLog, Warning,TEXT("[%s<%d>]  " format), TEXT(*FString(__FUNCTION__)), __LINE__, ##__VA_ARGS__)
#define YQZYError(format, ...) UE_LOG(YQZYLog, Error, TEXT("[%s<%d>]  " format), TEXT(*FString(__FUNCTION__)),  __LINE__, ##__VA_ARGS__)
#define YQZYFatal(format, ...) UE_LOG(YQZYLog, Fatal, TEXT("[%s<%d>]  " format), TEXT(*FString(__FUNCTION__)), __LINE__, ##__VA_ARGS__)
#endif
