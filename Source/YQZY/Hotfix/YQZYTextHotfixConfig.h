...
#include "YQZYTextHotfixConfig.generated.h"
...
class UYQZYTextHotfixConfig : public UDeveloperSettings
{
	GENERATED_BODY()

public:
	UYQZYTextHotfixConfig(const FObjectInitializer& ObjectInitializer);
