...
#include "YQZYPlatformEmulationSettings.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(YQZYPlatformEmulationSettings)

#define LOCTEXT_NAMESPACE "YQZYCheats"

UYQZYPlatformEmulationSettings::UYQZYPlatformEmulationSettings()
{
}

FName UYQZYPlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName UYQZYPlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName UYQZYPlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void UYQZYPlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UYQZYPlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void UYQZYPlatformEmulationSettings::PostInitProperties()
{
...
void UYQZYPlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void UYQZYPlatformEmulationSettings::ApplySettings()
{
...
void UYQZYPlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> UYQZYPlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> UYQZYPlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void UYQZYPlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
