...
#include "YQZYGameplayAbility_Interact.h"
...
#include "UI/IndicatorSystem/YQZYIndicatorManagerComponent.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(YQZYGameplayAbility_Interact)
...
UYQZYGameplayAbility_Interact::UYQZYGameplayAbility_Interact(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	ActivationPolicy = EYQZYAbilityActivationPolicy::OnSpawn;
	InstancingPolicy = EGameplayAbilityInstancingPolicy::InstancedPerActor;
	NetExecutionPolicy = EGameplayAbilityNetExecutionPolicy::LocalPredicted;
}

void UYQZYGameplayAbility_Interact::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
...
void UYQZYGameplayAbility_Interact::UpdateInteractions(const TArray<FInteractionOption>& InteractiveOptions)
{
	if (AYQZYPlayerController* PC = GetYQZYPlayerControllerFromActorInfo())
	{
		if (UYQZYIndicatorManagerComponent* IndicatorManager = UYQZYIndicatorManagerComponent::GetComponent(PC))
		{
...
void UYQZYGameplayAbility_Interact::TriggerInteraction()
{
