...
struct FGameFeatureAbilitiesEntry
{
	...
	UPROPERTY(EditAnywhere, Category="Abilities")
	TArray<FYQZYAbilityGrant> GrantedAbilities;

	// List of attribute sets to grant to actors of the specified class 
	UPROPERTY(EditAnywhere, Category="Attributes")
	TArray<FYQZYAttributeSetGrant> GrantedAttributes;

	// List of ability sets to grant to actors of the specified class
	UPROPERTY(EditAnywhere, Category="Attributes", meta=(AssetBundles="Client,Server"))
	TArray<TSoftObjectPtr<const UYQZYAbilitySet>> GrantedAbilitySets;
};
...
private:
	struct FActorExtensions
	{
		...
		TArray<FYQZYAbilitySet_GrantedHandles> AbilitySetHandles;
	};
