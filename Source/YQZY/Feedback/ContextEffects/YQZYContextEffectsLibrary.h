...
#include "YQZYContextEffectsLibrary.generated.h"
...
struct YQZY_API FYQZYContextEffects
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class YQZY_API UYQZYActiveContextEffects : public UObject
{
	GENERATED_BODY()
...
DECLARE_DYNAMIC_DELEGATE_OneParam(FYQZYContextEffectLibraryLoadingComplete, TArray<UYQZYActiveContextEffects*>, YQZYActiveContextEffects);

/**
 * 
 */
UCLASS(BlueprintType)
class YQZY_API UYQZYContextEffectsLibrary : public UObject
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly)
	TArray<FYQZYContextEffects> ContextEffects;
...
private:
	...
	void YQZYContextEffectLibraryLoadingComplete(TArray<UYQZYActiveContextEffects*> YQZYActiveContextEffects);

	UPROPERTY(Transient)
	TArray< TObjectPtr<UYQZYActiveContextEffects>> ActiveContextEffects;
