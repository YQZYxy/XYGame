...
#include UE_INLINE_GENERATED_CPP_BY_NAME(YQZYContextEffectsLibrary)


void UYQZYContextEffectsLibrary::GetEffects(const FGameplayTag Effect, const FGameplayTagContainer Context, 
...
void UYQZYContextEffectsLibrary::LoadEffects()
{
...
EContextEffectsLibraryLoadState UYQZYContextEffectsLibrary::GetContextEffectsLibraryLoadState()
{
	// Return current Load State
	return EffectsLoadState;
}

void UYQZYContextEffectsLibrary::LoadEffectsInternal()
{
	// TODO Add Async Loading for Libraries

	// Copy data for async load
	TArray<FYQZYContextEffects> LocalContextEffects = ContextEffects;

	// Prepare Active Context Effects Array
	TArray<UYQZYActiveContextEffects*> ActiveContextEffectsArray;

	// Loop through Context Effects
	for (const FYQZYContextEffects& ContextEffect : LocalContextEffects)
	{
		// Make sure Tags are Valid
		if (ContextEffect.EffectTag.IsValid() && ContextEffect.Context.IsValid())
		{
			// Create new Active Context Effect
			UYQZYActiveContextEffects* NewActiveContextEffects = NewObject<UYQZYActiveContextEffects>(this);
	...
	this->YQZYContextEffectLibraryLoadingComplete(ActiveContextEffectsArray);
}

void UYQZYContextEffectsLibrary::YQZYContextEffectLibraryLoadingComplete(
	TArray<UYQZYActiveContextEffects*> YQZYActiveContextEffects)
{
	// Flag data as loaded
	...
	ActiveContextEffects.Append(YQZYActiveContextEffects);
}
