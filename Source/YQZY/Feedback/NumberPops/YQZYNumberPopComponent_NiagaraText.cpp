...
#include "YQZYNumberPopComponent_NiagaraText.h"

#include "Feedback/NumberPops/YQZYNumberPopComponent.h"
#include "YQZYDamagePopStyleNiagara.h"
#include "YQZYLog.h"
#include "NiagaraComponent.h"
#include "NiagaraDataInterfaceArrayFunctionLibrary.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(YQZYNumberPopComponent_NiagaraText)

UYQZYNumberPopComponent_NiagaraText::UYQZYNumberPopComponent_NiagaraText(const FObjectInitializer& ObjectInitializer)
...
void UYQZYNumberPopComponent_NiagaraText::AddNumberPop(const FYQZYNumberPopRequest& NewRequest)
{
	...
	UE_LOG(YQZYLog, Log, TEXT("DamageHit location : %s"), *(NewRequest.WorldLocation.ToString()));
