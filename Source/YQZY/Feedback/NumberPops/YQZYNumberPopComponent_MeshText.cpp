...
#include "YQZYNumberPopComponent_MeshText.h"

#include "Components/StaticMeshComponent.h"
#include "Engine/CollisionProfile.h"
#include "Engine/Engine.h"
#include "Engine/World.h"
#include "Feedback/NumberPops/YQZYNumberPopComponent.h"
#include "YQZYDamagePopStyle.h"
#include "Materials/MaterialInstanceDynamic.h"
#include "TimerManager.h"
#include "UObject/Package.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(YQZYNumberPopComponent_MeshText)

class UStaticMesh;

UYQZYNumberPopComponent_MeshText::UYQZYNumberPopComponent_MeshText(const FObjectInitializer& ObjectInitializer)
...
void UYQZYNumberPopComponent_MeshText::AddNumberPop(const FYQZYNumberPopRequest& NewRequest)
{
...
void UYQZYNumberPopComponent_MeshText::ReleaseNextComponents()
{
	UWorld* LocalWorld = GetWorld();
	check(LocalWorld);
...
FLinearColor UYQZYNumberPopComponent_MeshText::DetermineColor(const FYQZYNumberPopRequest& Request) const
{
	for (UYQZYDamagePopStyle* Style : Styles)
	{
...
UStaticMesh* UYQZYNumberPopComponent_MeshText::DetermineStaticMesh(const FYQZYNumberPopRequest& Request) const
{
	for (UYQZYDamagePopStyle* Style : Styles)
	{
...
void UYQZYNumberPopComponent_MeshText::SetMaterialParameters(const FYQZYNumberPopRequest& Request, FTempNumberPopInfo& NewDamageNumberInfo, const FTransform& CameraTransform, const FVector& NumberLocation)
{
