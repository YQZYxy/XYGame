...
#include "YQZYWidgetFactory_Class.h"

#include "Blueprint/UserWidget.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(YQZYWidgetFactory_Class)

TSubclassOf<UUserWidget> UYQZYWidgetFactory_Class::FindWidgetClassForData_Implementation(const UObject* Data) const
{
