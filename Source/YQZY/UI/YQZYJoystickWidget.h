...
#include "YQZYJoystickWidget.generated.h"
...
/**
 *  A UMG wrapper for the YQZY virtual joystick.
 *
 ...
 */
UCLASS(meta=( DisplayName="YQZY Joystick" ))
class YQZY_API UYQZYJoystickWidget : public UYQZYSimulatedInputWidget
{
	GENERATED_BODY()
	
public:
	
	UYQZYJoystickWidget(const FObjectInitializer& ObjectInitializer);
