...
#include UE_INLINE_GENERATED_CPP_BY_NAME(YQZYHUD)
...
AYQZYHUD::AYQZYHUD(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	PrimaryActorTick.bStartWithTickEnabled = false;
}

void AYQZYHUD::PreInitializeComponents()
{
...
void AYQZYHUD::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
void AYQZYHUD::GetDebugActorList(TArray<AActor*>& InOutList)
{
