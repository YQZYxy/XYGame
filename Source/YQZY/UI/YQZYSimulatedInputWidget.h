...
#include "YQZYSimulatedInputWidget.generated.h"
 ...
 */
UCLASS(meta=( DisplayName="YQZY Simulated Input Widget" ))
class YQZY_API UYQZYSimulatedInputWidget : public UCommonUserWidget
{
	GENERATED_BODY()
	
public:
	
	UYQZYSimulatedInputWidget(const FObjectInitializer& ObjectInitializer);
