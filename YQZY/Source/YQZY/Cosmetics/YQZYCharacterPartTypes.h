...
#include "YQZYCharacterPartTypes.generated.h"
...
struct FYQZYCharacterPartHandle
{
	GENERATED_BODY()
...
struct FYQZYCharacterPart
{
	...
	static bool AreEquivalentParts(const FYQZYCharacterPart& A, const FYQZYCharacterPart& B)
	{
