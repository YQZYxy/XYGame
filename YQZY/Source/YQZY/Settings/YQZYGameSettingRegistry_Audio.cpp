...
#include "CustomSettings/YQZYSettingValueDiscreteDynamic_AudioOutputDevice.h"
...
UGameSettingCollection* UYQZYGameSettingRegistry::InitializeAudioSettings(UYQZYLocalPlayer* InLocalPlayer)
{
	...
	////////////////////////////////////////////////////////////////////////////////////
	{
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UYQZYSettingsLocal>()->GetOverallVolume());
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UYQZYSettingsLocal>()->GetMusicVolume());
			Setting->SetDisplayFormat(UGameSettingValueScalarDynamic::ZeroToOnePercent);
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UYQZYSettingsLocal>()->GetSoundFXVolume());
			Setting->SetDisplayFormat(UGameSettingValueScalarDynamic::ZeroToOnePercent);
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UYQZYSettingsLocal>()->GetDialogueVolume());
			Setting->SetDisplayFormat(UGameSettingValueScalarDynamic::ZeroToOnePercent);
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UYQZYSettingsLocal>()->GetVoiceChatVolume());
			Setting->SetDisplayFormat(UGameSettingValueScalarDynamic::ZeroToOnePercent);
	...
	////////////////////////////////////////////////////////////////////////////////////
	{
		...
		//----------------------------------------------------------------------------------
		{
			...
			////////////////////////////////////////////////////////////////////////////////////
			{
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<UYQZYSettingsShared>()->GetSubtitlesEnabled());
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<UYQZYSettingsShared>()->GetSubtitlesTextSize());
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<UYQZYSettingsShared>()->GetSubtitlesTextColor());
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<UYQZYSettingsShared>()->GetSubtitlesTextBorder());
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<UYQZYSettingsShared>()->GetSubtitlesBackgroundOpacity());
		...
		//----------------------------------------------------------------------------------
		{
			UYQZYSettingValueDiscreteDynamic_AudioOutputDevice* Setting = NewObject<UYQZYSettingValueDiscreteDynamic_AudioOutputDevice>();
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UYQZYSettingsShared>()->GetAllowAudioInBackgroundSetting());

			Setting->AddEnumOption(EYQZYAllowBackgroundAudioSetting::Off, LOCTEXT("EYQZYAllowBackgroundAudioSetting_Off", "Off"));
			Setting->AddEnumOption(EYQZYAllowBackgroundAudioSetting::AllSounds, LOCTEXT("EYQZYAllowBackgroundAudioSetting_AllSounds", "All Sounds"));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UYQZYSettingsLocal>()->IsHeadphoneModeEnabled());

			Setting->AddEditCondition(MakeShared<FWhenCondition>(
				[](const ULocalPlayer*, FGameSettingEditableState& InOutEditState)
				{
					if (!GetDefault<UYQZYSettingsLocal>()->CanModifyHeadphoneModeEnabled())
					{
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UYQZYSettingsLocal>()->IsHDRAudioModeEnabled());
