...
#include "YQZYSafeZoneEditor.generated.h"
...
UCLASS(Abstract)
class UYQZYSafeZoneEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UYQZYSafeZoneEditor(const FObjectInitializer& Initializer);
