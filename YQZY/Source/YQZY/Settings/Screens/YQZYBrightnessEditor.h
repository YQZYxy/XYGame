...
#include "YQZYBrightnessEditor.generated.h"
...
UCLASS(Abstract)
class UYQZYBrightnessEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UYQZYBrightnessEditor(const FObjectInitializer& Initializer);
