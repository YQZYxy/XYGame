...
void UAbilityTask_GrantNearbyInteraction::QueryInteractables()
{
	...
	if (World && ActorOwner)
	{
		...
		World->OverlapMultiByChannel(OUT OverlapResults, ActorOwner->GetActorLocation(), FQuat::Identity, YQZY_TraceChannel_Interaction, FCollisionShape::MakeSphere(InteractionScanRange), Params);
