...
#include "YQZYWeaponInstance.generated.h"
 ...
 */
UCLASS()
class UYQZYWeaponInstance : public UYQZYEquipmentInstance
{
	GENERATED_BODY()

public:
	UYQZYWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	FYQZYAnimLayerSelectionSet EquippedAnimSet;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=Animation)
	FYQZYAnimLayerSelectionSet UneuippedAnimSet;
