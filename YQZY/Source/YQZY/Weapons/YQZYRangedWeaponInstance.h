...
#include "YQZYRangedWeaponInstance.generated.h"

class UPhysicalMaterial;

/**
 * UYQZYRangedWeaponInstance
 *
 * A piece of equipment representing a ranged weapon spawned and applied to a pawn
 */
UCLASS()
class UYQZYRangedWeaponInstance : public UYQZYWeaponInstance, public IYQZYAbilitySourceInterface
{
	GENERATED_BODY()

public:
	UYQZYRangedWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
public:
	...
	//~UYQZYEquipmentInstance interface
	virtual void OnEquipped();
	virtual void OnUnequipped();
	//~End of UYQZYEquipmentInstance interface

	void AddSpread();

	//~IYQZYAbilitySourceInterface interface
	...
	//~End of IYQZYAbilitySourceInterface interface
