...
#include "YQZYReticleWidgetBase.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(YQZYReticleWidgetBase)

UYQZYReticleWidgetBase::UYQZYReticleWidgetBase(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UYQZYReticleWidgetBase::InitializeFromWeapon(UYQZYWeaponInstance* InWeapon)
{
	WeaponInstance = InWeapon;
	InventoryInstance = nullptr;
	if (WeaponInstance)
	{
		InventoryInstance = Cast<UYQZYInventoryItemInstance>(WeaponInstance->GetInstigator());
	}
	OnWeaponInitialized();
}


float UYQZYReticleWidgetBase::ComputeSpreadAngle() const
{
	if (const UYQZYRangedWeaponInstance* RangedWeapon = Cast<const UYQZYRangedWeaponInstance>(WeaponInstance))
	{
...
bool UYQZYReticleWidgetBase::HasFirstShotAccuracy() const
{
	if (const UYQZYRangedWeaponInstance* RangedWeapon = Cast<const UYQZYRangedWeaponInstance>(WeaponInstance))
	{
...
float UYQZYReticleWidgetBase::ComputeMaxScreenspaceSpreadRadius() const
{
