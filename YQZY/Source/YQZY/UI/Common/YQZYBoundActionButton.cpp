...
#include "YQZYBoundActionButton.h"

#include "CommonInputSubsystem.h"
#include "CommonInputTypeEnum.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(YQZYBoundActionButton)

class UCommonButtonStyle;

void UYQZYBoundActionButton::NativeConstruct()
{
...
void UYQZYBoundActionButton::HandleInputMethodChanged(ECommonInputType NewInputMethod)
{
