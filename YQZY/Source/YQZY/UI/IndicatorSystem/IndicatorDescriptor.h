...
class YQZY_API UIndicatorDescriptor : public UObject
{
	GENERATED_BODY()
...
public:
	UYQZYIndicatorManagerComponent* GetIndicatorManagerComponent() { return ManagerPtr.Get(); }
	void SetIndicatorManagerComponent(UYQZYIndicatorManagerComponent* InManager);
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<UYQZYIndicatorManagerComponent> ManagerPtr;
