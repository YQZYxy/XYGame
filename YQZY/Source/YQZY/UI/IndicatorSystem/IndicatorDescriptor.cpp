...
void UIndicatorDescriptor::SetIndicatorManagerComponent(UYQZYIndicatorManagerComponent* InManager)
{
...
{
	if (UYQZYIndicatorManagerComponent* Manager = ManagerPtr.Get())
	{
