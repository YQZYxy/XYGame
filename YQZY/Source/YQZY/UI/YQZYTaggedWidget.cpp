...
#include "YQZYTaggedWidget.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(YQZYTaggedWidget)

//@TODO: The other TODOs in this file are all related to tag-based showing/hiding of widgets, see UE-142237

UYQZYTaggedWidget::UYQZYTaggedWidget(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UYQZYTaggedWidget::NativeConstruct()
{
...
void UYQZYTaggedWidget::NativeDestruct()
{
	if (!IsDesignTime())
	{
...
void UYQZYTaggedWidget::SetVisibility(ESlateVisibility InVisibility)
{
...
void UYQZYTaggedWidget::OnWatchedTagsChanged()
{
	const bool bHasHiddenTags = false;//@TODO: Foo->HasAnyTags(HiddenByTags);
