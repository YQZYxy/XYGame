...
#include "YQZYGameFeaturePolicy.generated.h"
...
class UYQZYGameFeaturePolicy : public UDefaultGameFeaturesProjectPolicies
{
	GENERATED_BODY()

public:
	YQZY_API static UYQZYGameFeaturePolicy& Get();

	UYQZYGameFeaturePolicy(const FObjectInitializer& ObjectInitializer);
...
// checked
UCLASS()
class UYQZYGameFeature_HotfixManager : public UObject, public IGameFeatureStateChangeObserver
{
	GENERATED_BODY()
...
// checked
UCLASS()
class UYQZYGameFeature_AddGameplayCuePaths : public UObject, public IGameFeatureStateChangeObserver
{
	GENERATED_BODY()
