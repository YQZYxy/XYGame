...
#include "Character/YQZYHeroComponent.h"	// for NAME_BindInputsNow
...
void UGameFeatureAction_AddInputConfig::HandlePawnExtension(AActor* Actor, FName EventName, FGameFeatureStateChangeContext ChangeContext)
{
	...
	if (EventName == UGameFrameworkComponentManager::NAME_ExtensionAdded || EventName == UYQZYHeroComponent::NAME_BindInputsNow)
	{
