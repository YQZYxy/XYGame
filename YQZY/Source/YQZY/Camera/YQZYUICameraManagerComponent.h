...
#include "YQZYUICameraManagerComponent.generated.h"

class AYQZYPlayerCameraManager;
...
UCLASS( Transient, Within=YQZYPlayerCameraManager )
class UYQZYUICameraManagerComponent : public UActorComponent
{
	GENERATED_BODY()

public:
	static UYQZYUICameraManagerComponent* GetComponent(APlayerController* PC);

public:
	UYQZYUICameraManagerComponent();	
