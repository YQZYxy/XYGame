...
public:
	...
	TObjectPtr<UYQZYInventoryItemInstance> Item = nullptr;
};
...
public:
	...
	static void AddPickupToInventory(UYQZYInventoryManagerComponent* InventoryComponent, TScriptInterface<IPickupable> Pickup);
};
