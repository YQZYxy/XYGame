...
void UAsyncAction_ExperienceReady::Step2_ListenToExperienceLoading(AGameStateBase* GameState)
{
	...
	{
		ExperienceComponent->CallOrRegister_OnExperienceLoaded(FOnYQZYExperienceLoaded::FDelegate::CreateUObject(this, &ThisClass::Step3_HandleExperienceLoaded));
	}
}

void UAsyncAction_ExperienceReady::Step3_HandleExperienceLoaded(const UYQZYExperienceDefinition* CurrentExperience)
{
