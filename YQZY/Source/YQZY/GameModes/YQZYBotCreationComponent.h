...
#include "YQZYBotCreationComponent.generated.h"
...
class UYQZYBotCreationComponent : public UGameStateComponent
{
	GENERATED_BODY()

public:
	UYQZYBotCreationComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
