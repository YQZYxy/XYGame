...
#include "YQZYUserFacingExperienceDefinition.generated.h"
...
class UYQZYUserFacingExperienceDefinition : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category=Experience, meta=(AllowedTypes="YQZYExperienceDefinition"))
