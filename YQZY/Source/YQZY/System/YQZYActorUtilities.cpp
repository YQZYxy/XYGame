...
#include "YQZYActorUtilities.h"

#include "GameFramework/Actor.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(YQZYActorUtilities)

EBlueprintExposedNetMode UYQZYActorUtilities::SwitchOnNetMode(const UObject* WorldContextObject)
{
