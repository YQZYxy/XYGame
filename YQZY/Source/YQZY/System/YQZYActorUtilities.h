...
#include "YQZYActorUtilities.generated.h"
...
UCLASS()
class UYQZYActorUtilities : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="YQZY", meta=(WorldContext="WorldContextObject", ExpandEnumAsExecs=ReturnValue))
