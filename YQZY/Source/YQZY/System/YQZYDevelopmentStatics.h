...
#include "YQZYDevelopmentStatics.generated.h"
...
UCLASS()
class UYQZYDevelopmentStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()

public:
	// Should game logic skip directly to gameplay (skipping any match warmup / waiting for players / etc... aspects)
	// Will always return false except when playing in the editor and bTestFullGameFlowInPIE (in YQZY Developer Settings) is false
	...
	// Will always return true except when playing in the editor and bSkipLoadingCosmeticBackgroundsInPIE (in YQZY Developer Settings) is true
	UFUNCTION(BlueprintCallable, Category = "YQZY", meta=(ExpandBoolAsExecs="ReturnValue"))
