...
class UYQZYReplayList;
class UObject;
struct FEnumerateStreamsResult;
struct FFrame;

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FQueryReplayAsyncDelegate, UYQZYReplayList*, Results);
...
private:
	UPROPERTY()
	TObjectPtr<UYQZYReplayList> ResultList;
