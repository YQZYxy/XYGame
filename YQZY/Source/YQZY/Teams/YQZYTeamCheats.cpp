...
#include UE_INLINE_GENERATED_CPP_BY_NAME(YQZYTeamCheats)

//////////////////////////////////////////////////////////////////////
// UYQZYTeamCheats

void UYQZYTeamCheats::CycleTeam()
{
...
void UYQZYTeamCheats::SetTeam(int32 TeamID)
{
	if (UYQZYTeamSubsystem* TeamSubsystem = UWorld::GetSubsystem<UYQZYTeamSubsystem>(GetWorld()))
	{
...
void UYQZYTeamCheats::ListTeams()
{
	if (UYQZYTeamSubsystem* TeamSubsystem = UWorld::GetSubsystem<UYQZYTeamSubsystem>(GetWorld()))
	{
		const TArray<int32> TeamIDs = TeamSubsystem->GetTeamIDs();
