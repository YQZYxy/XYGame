...
#include "YQZYPerformanceStatSubsystem.generated.h"
...
struct FYQZYPerformanceStatCache : public IPerformanceDataConsumer
{
public:
	FYQZYPerformanceStatCache(UYQZYPerformanceStatSubsystem* InSubsystem)
	...
	double GetCachedStat(EYQZYDisplayablePerformanceStat Stat) const;

protected:
	IPerformanceDataConsumer::FFrameData CachedData;
	UYQZYPerformanceStatSubsystem* MySubsystem;
...
class UYQZYPerformanceStatSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
...
protected:
	TSharedPtr<FYQZYPerformanceStatCache> Tracker;
};
