...
#include "YQZYNotificationMessage.generated.h"

class UObject;

YQZY_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_YQZY_AddNotification_Message);

class APlayerState;

// A message destined for a transient log (e.g., an elimination feed or inventory pickup stream)
USTRUCT(BlueprintType)
struct YQZY_API FYQZYNotificationMessage
{
	GENERATED_BODY()
